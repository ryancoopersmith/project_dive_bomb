...
class BarList extends Component {
  ...
  getBars() {
    fetch('https://frozen-wave-13196.herokuapp.com/api/v1/bars.json') // https://frozen-wave-13196.herokuapp.com/api/v1/bars.json if deployed on heroku http://localhost:3000/api/v1/bars.json for development
      .then(response => {
        if (response.ok) {
          return response;
        } else {
