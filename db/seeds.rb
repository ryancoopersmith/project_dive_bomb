...
if Rails.env.development? || Rails.env.production?
  ...
  Bar.create!(name: 'The Green Room', address: '1940 Green St', city: 'Philadelphia', state: 'PA', zip: '19130', phone_number: '215-241-6676', url: 'http://greenroomphiladelphia.com/', image_url: 'http://media.phillyvoice.com/media/images/Screen_Shot_2015-05-25_at_7.11.56_P.focus-none.width-800.png', description: 'American grub & beer offered in a snug saloon setting with pool tables & an old-school vibe.')

  Bar.create!(name: 'The Institute', address: '549 N 12th St', city: 'Philadelphia', state: 'PA', zip: '19123', phone_number: '215-787-0888', url: 'http://www.institutebar.com/', image_url: 'https://i1.wp.com/eraserhood.com/wp-content/uploads/2017/01/10381382364_11ac09ca5a_b.jpg?resize=915%2C1024', description: 'This quaint 2-story hangout offers taps of craft beers & private booths (each with its own TV).')

  Bar.create!(name: 'Lorraine', address: '1502 Brown St', city: 'Philadelphia', state: 'PA', zip: '19130', phone_number: '215-232-4282', image_url: 'https://s3-media3.fl.yelpcdn.com/bphoto/khtTbOWuXI6-vXR2mZpbMg/o.jpg', description: 'Little corner spot whose highlight is definitely the large outdoor backyard.')

  Bar.create!(name: 'The Barbary', address: '951 Frankfort Ave', city: 'Philadelphia', state: 'PA', zip: '19125', phone_number: '215-634-7400', url: 'https://www.facebook.com/thebarbary/', image_url: 'http://cdn.clubzone.com/content/uploads/places/17332/1-600x430.jpg', description: 'DJs set the scene for dance parties along with frequent live bands at this cash-only club.')

  Bar.create!(name: 'El Bar', address: '1356 N Front St', city: 'Philadelphia', state: 'PA', zip: '19122', phone_number: '215-634-6430', url: 'https://www.facebook.com/The-El-Bar-76572966730/', image_url: 'http://fishtownbeerrunners.com/wp-content/uploads/2015/12/The-El-Bar-.jpg', description: 'Cash-only dive bar with a deck under the train tracks has weekly live music & draws a diverse crowd.')

  Bar.create!(name: 'Kung Fu Necktie', address: '1250 N Front St', city: 'Philadelphia', state: 'PA', zip: '19122', phone_number: '215-291-4919', url: 'http://www.kungfunecktie.com/', image_url: 'https://laurenzapata.files.wordpress.com/2011/06/kfn.jpg', description: 'Live bands play most nights at this 2-floor watering hole with red-leather booths & dim lighting.')

  Bar.create!(name: 'Handle Bar', address: '1102 Frankfort Ave', city: 'Philadelphia', state: 'PA', zip: '19123', phone_number: '215-425-2005', url: 'https://www.facebook.com/pages/The-Handle-Bar/115846711776769', image_url: 'http://www.thejawn.com/jawn-photos/the-handle-bar-philadelphia-1345059385.jpg', description: 'Blink and you\'ll miss it, this hole in the wall can appear somewhat rough but is a dive in the truest sense. For a true respite from the trendier bars in the area, pop into here for a quick pre or post game drink.')

  Bar.create!(name: '700 Club', address: '700 N 2nd St', city: 'Philadelphia', state: 'PA', zip: '19123', phone_number: '215-413-3181', url: 'http://www.the700.org/', image_url: 'http://cdn.clubzone.com/content/uploads/places/16453/1-650x430.jpg', description: 'This multilevel sports bar is a regular haunt for soccer fanatics & also offers DJs & dancing.')

  Bar.create!(name: 'Ortliebs', address: '847 N 3rd Street', city: 'Philadelphia', state: 'PA', zip: '19123', phone_number: '215-324-3348', url: 'http://ortliebslounge.ticketfly.com/', image_url: 'http://www.phillyliving.com/images/blogs/2013/02/DSCF2079.jpg', description: 'Local funk, jazz & rock performers provide the soundtrack for burgers, burritos & beer drinking.')

  Bar.create!(name: 'Saint Lazarus', address: '102 W Girard Ave', city: 'Philadelphia', state: 'PA', zip: '19123', phone_number: '215-258-8332', url: 'https://www.facebook.com/saintlazarusbar/', image_url: 'http://philly.thedrinknation.com/images/bars/bar_picture_the_saint_philly.jpg', description: 'Cocktails, Southern pub grub & DJ\'d dance parties offered in a cool nightclub with an edgy vibe.')
